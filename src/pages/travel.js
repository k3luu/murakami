  ...
  <br /> */}
        ...
        <Card>
          ...
          <p>
            ...
            longer so please plan accordingly if you're taking one to the
            wedding.
          </p>
        </Card>
        <Card>
          ...
          <p>
            ...
            <br />
            <br />
            Airbnbs - We tend to find that Airbnbs are more affordable,
            especially this time of year, so get a group together and book a
            house early!
          </p>
        </Card>
        <Card>
          ...
          <p>
            ...
            <br />
            <br />
            Parking - There is plenty of parking if you choose to drive there,
            but we highly recommend those imbibing to take an Uber.
          </p>
        </Card>
        <Card>
          <h2>
